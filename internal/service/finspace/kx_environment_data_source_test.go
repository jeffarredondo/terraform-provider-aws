...
func TestAccKxEnvironmentDataSource_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccKxEnvironmentDataSourceConfig_optionsBasic,
...
var testAccKXEnvironmentDataSourceConfig_optionsBasic = acctest.ConfigCompose(testAccKxEnvironmentConfigBase, `
...
data "aws_finspace_kx_environment" "test" {
